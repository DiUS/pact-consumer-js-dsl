...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    define('mockService', ['pactDetails', 'interaction'], factory);
  } else {
    root.MockService = factory(root.PactDetails, root.Interaction);
  }
}(this, function (PactDetails, Interaction) {
  var _baseURL = "";
  ...
  return {
    create: function(consumerName, providerName, port, pactDir) {
      return new MockService(consumerName, providerName, port, pactDir);
    }
  }
}));
